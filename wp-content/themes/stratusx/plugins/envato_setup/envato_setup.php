...
";
    ...
    public function setup_wizard_header() {
                                ...
                                if ('_elementor_edit_mode' == $meta_key && 'builder' === $meta_val){
                                    ...
                                    if(!isset($elm_page_settings_array) || empty($elm_page_settings_array)) {
                                        ...
                                        $group1 = array("home-product-vr", "home-app", "home-startup",
                                            ...
                                            "home-app-3", "home-dark-app", "home-help-center","home-coming-soon",
                                            "about-us-modern", "careers-modern", "contact-modern", "portfolio-agency",
                                            "pricing-modern", "home-biotech","about-us-dark","about-us-monochrome",
                                            "pricing-dark","pricing-monochrome","careers-dark","careers-monochrome",
                                            "contact-dark","contact-monochrome","home-seo-company","home-cyber-security");
                                        ...
                                        $group3 = array( "home-saas","home-cloud","home-parallax","home-product-promotion",
                                            "home-video","home-startup-2","home-agency","home-app-landing","home-crowdsourcing",
                                            "about-us-light","careers-light","contact-light","pricing-light");
        ...
        public function envato_setup_color_style() {
            ...
            ?>
            <h1><?php esc_html_e( 'Import the Stratus starter kit', 'stratus' ); ?></h1>
            <form method="post">
                <p><?php esc_html_e( 'Includes most pages from the demo. It’s large so it may take a couple of minutes.', 'stratus' ); ?></p>
            ...
            <p><?php esc_html_e( 'Looking for something specific? Try our new Visual Library.', 'stratus' ); ?> - <a href=" https://themovation.helpscoutdocs.com/article/307-visual-library" target="_blank"><?php esc_html_e( 'Learn more','stratus' ); ?></a></p>
            <p><img src="<?php echo esc_url( $this->plugin_url . 'images/visual-library-setup.jpg' ); ?>" alt="Visual Library" />
